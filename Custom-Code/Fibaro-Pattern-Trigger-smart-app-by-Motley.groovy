...
//  iconX2Url: 		"https://s3.amazonaws.com/smartapp-icons/Meta/light_contact-outlet@2x.png"   setColor(ffff00)
)
...
preferences {
  ...
  section("Activate this/these Fibaro Light(s)..."){
    input "switches", "capability.switch", title: "Which Target(s)?", multiple: true
  }
  section("Set pattern to the following..."){
    input "pattern1", "enum", title: "Which pattern?", description: "Select the pattern to use", options: ["Off","red","green","blue","LightRed","LightGreen","LightBlue","cyan","magenta","yellow","orange","pink","purple","RichPurple","warmWhite","coldWhite","fireplace","storm","deepfade","litefade","police"], multiple: false, required: true
  }
}
def installed() {
